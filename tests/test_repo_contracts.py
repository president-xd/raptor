...
class RepositoryContractTests(unittest.TestCase):
    ...
    def test_env_example_uses_safe_local_defaults(self):
        ...
        self.assertIn("LLM_PROVIDER=nvidia", env)
        self.assertIn("NVIDIA_API_KEY=", env)
        self.assertIn("NVIDIA_BASE_URL=https://integrate.api.nvidia.com/v1", env)
        self.assertIn("LLM_MODEL=z-ai/glm-5.1", env)
        self.assertIn("LLM_STREAM_RESPONSES=true", env)
        self.assertIn("LLM_ENABLE_THINKING=true", env)
